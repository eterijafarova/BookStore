        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    GenreName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, comment: "The name of the genre"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAttributeValue", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookAttributeValue_BookAttribute_AttributeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromoCode = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    ...
                    UserBankCardId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookAttributeValue_AttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreOrders_UserName_Title_Author",
                table: "PreOrders",
                columns: new[] { "UserName", "Title", "Author" },
                unique: true);
